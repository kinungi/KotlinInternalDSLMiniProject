...
@DslMarker
annotation class SimpleHouseGameDSL
object house{
    ...
    // some rules need to be followed to make use of infix function.
...
class RoomListBuilder {
    ...
    //room without people can be implemented to have more functionality
    infix  fun room.without(p:people){
        rooms += Room(listOf())
    }
}
fun rooms(actions: RoomListBuilder.() -> Unit):List<Room>{
